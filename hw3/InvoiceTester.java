 ...
 import java.awt.*;
    ...
    public class InvoiceTester
   {
      public static void main(String[] args)
      {
         ...
         textArea.setForeground(new Color(0x0000A0));
         ...
         combo.setForeground(new Color(0x008000));
         combo.setFont(new Font ("Garamond", Font.PLAIN , 15));
         ...
         addButton.setForeground(new Color(0xff0000));
